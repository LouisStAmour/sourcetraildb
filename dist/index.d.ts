 ...
 */
export declare class NameElement {
...
export declare enum ReferenceKind {
    ...
    TEMPLATE_ARGUMENT = 5,
    TYPE_ARGUMENT = 6,
    TEMPLATE_DEFAULT_ARGUMENT = 7,
    TEMPLATE_SPECIALIZATION = 8,
    TEMPLATE_MEMBER_SPECIALIZATION = 9,
    INCLUDE = 10,
    IMPORT = 11,
    MACRO_USAGE = 12,
    ANNOTATION_USAGE = 13
...
export declare class SourceRange {
    constructor(fileId: FileId, startLine: number, startColumn: number, endLine: number, endColumn: number);
    fileId: FileId;
    startLine: number;
    startColumn: number;
    endLine: number;
...
export declare class WriterType {
     ...
     *  see: DefinitionKind
     */
    recordSymbolDefinitionKind(symbolId: SymbolId, definitionKind: DefinitionKind): boolean;
    /**
     ...
     *  see: SourceRange
     */
    recordSymbolSignatureLocation(symbolId: SymbolId, location: SourceRange): boolean;
    /**
     ...
     *  see: ReferenceKind
     */
    recordReference(contextSymbolId: SymbolId, referencedSymbolId: SymbolId, referenceKind: ReferenceKind): ReferenceId;
    /**
     ...
     *  see: SourceRange
     */
    recordReferenceLocation(referenceId: ReferenceId, location: SourceRange): boolean;
    /**
     ...
     *  see: SourceRange
     */
    recordReferenceToUnsolvedSymhol(contextSymbolId: SymbolId, referenceKind: ReferenceKind, location: SourceRange): ReferenceId;
    /**
     ...
     *  see: SourceRange
     */
    recordQualifierLocation(referencedSymbolId: SymbolId, location: SourceRange): boolean;
    /**
     ...
     *  see: SourceRange
     */
    recordLocalSymbolLocation(localSymbolId: LocalSymbolId, location: SourceRange): boolean;
    /**
